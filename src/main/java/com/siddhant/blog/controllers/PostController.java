...
import com.siddhant.blog.config.AppConstants;
...
import com.siddhant.blog.services.FileService;
import com.siddhant.blog.services.PostService;
	...
	//update post
		...
		@DeleteMapping("/posts/{postId}")
			public ResponseEntity<ApiResponse> deletePost(@PathVariable Integer postId){
				...
				return new ResponseEntity<ApiResponse>(new ApiResponse("post is delete successfully",true),HttpStatus.OK); 
		}
		//search
